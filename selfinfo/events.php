...
<body>
  ...
  <div class="overlay container">
    <table class="table">
      ...
      <h1><? if ($_SESSION['nimbus_access'] > 0) { echo $_SESSION['nimbus_first_name'] . "'s "; } else { echo "My "; } ?>Events <? echo $v; ?></h1>
      <p>Filter by: <a href="/~circlek/selfinfo/eventsawards.php">Award Categories</a>, <a href="/~circlek/selfinfo/committee.php">Committee Meetings</a>, <a href="/~circlek/selfinfo/kiwanis.php">Kiwanis Meetings</a>, <a href="/~circlek/selfinfo/chaired.php">Chaired Events</a></p>
      <tbody>
