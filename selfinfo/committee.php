<?php
  ...
  ** My Committee Meetings (committee.php)
  **
  ...
  **/
  $pageTitle = "My Committee Meetings";
  session_start();
...
<body>
  ...
  <div class="overlay container">
    <table class="table" >
      ...
      <h1><? if ($_SESSION['nimbus_access'] > 0) { echo $_SESSION['nimbus_first_name'] . "'s "; } else { echo "My "; } ?>Committee Meetings</h1>
      <p>Filter by: <a href="/~circlek/selfinfo/events.php">All Events</a>, <a href="/~circlek/selfinfo/eventsawards.php">Award Categories</a>, <a href="/~circlek/selfinfo/kiwanis.php">Kiwanis Meetings</a>, <a href="/~circlek/selfinfo/chaired.php">Chaired Events</a></p>
      <tbody>
      <? foreach ($events as $event) { 
          if(strpos($event['name'], 'Committee') > 0) { 
